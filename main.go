...
func main() {
	...
	http.ListenAndServe(":8065", nil) // Bu satır, HTTP sunucusunu başlatır ve belirtilen portu dinlemeye başlar.
	//İkinci parametre olarak nil verilmiş, bu da varsayılan multiplexer'ın kullanılacağı anlamına gelir.
}
